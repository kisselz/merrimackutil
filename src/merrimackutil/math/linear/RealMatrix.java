...
public class RealMatrix
{
     ...
     */
    public RealMatrix hadamardMultiply(RealMatrix mat) throws IllegalArgumentException 
    {
        RealMatrix res = new RealMatrix(mat.getNumRows(), mat.getNumCols());
     ...
     */
    public RealMatrix augmentCols(RealMatrix mat) throws IllegalArgumentException
    {
        RealMatrix res = new RealMatrix(mat.getNumRows(), this.numCols + mat.getNumCols());
     ...
     * @throws IllegalArgumentException if the number of rows in the two matrices don't match.
     */
    public RealMatrix augmentRows(RealMatrix mat) throws IllegalArgumentException
    {
        RealMatrix res = new RealMatrix(mat.getNumRows(), this.numCols + mat.getNumCols());
